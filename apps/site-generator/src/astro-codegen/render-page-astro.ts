...
//     import { makeGetStaticPaths } from "@workspace/ui/lib/astro-i18n/get-static-paths";
//
...
// 內容完全無關，抽成 `@workspace/ui/lib/astro-i18n/get-static-paths.ts` 的
...
export function renderPageAstro(options: RenderPageAstroFileOptions): RenderedPageAstro {
  ...
  // 樣板精簡（方向 C）」說明、@workspace/ui/lib/astro-i18n/get-static-paths.ts）。
...
// @workspace/ui/lib/astro-i18n/get-static-paths.ts 的 makeGetStaticPaths()。
