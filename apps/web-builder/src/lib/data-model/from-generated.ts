...
// 生成資料 → FieldType 的轉換層
//
// 讀取 apps/web-builder/scripts/docs/generate-docs.mjs 產生的
// /data/components.json / /data/component-types.json，轉換成 data-model
// 可用的 FieldType / component props registry。生成流程本身完全不動，
// 這裡只消費它的輸出。
//
