 ...
 * documents, etc.): an optional eyebrow line, a large title and an
 * intro paragraph inside a glass panel.
 */
export function PageIntro({ title, intro, eyebrow }: PageIntroProps) {
  return (
    <section className="mx-auto mt-10 max-w-3xl sm:mt-16">
      <div className="glass rounded-3xl p-6 sm:p-10">
        ...
        <h1 className={`text-4xl font-black tracking-tight sm:text-5xl ${eyebrow ? "mt-2" : ""}`}>
          {title}
        </h1>
