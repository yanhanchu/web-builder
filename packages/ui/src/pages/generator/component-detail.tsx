...
export function ComponentDetail() {
  ...
  // id 是 `{filePath}#{componentName}` 組合而成，經 encodeURIComponent 編碼進路由，
  // 這裡先解碼還原成原始 id 再查找（id 目前已全域唯一，不需要陣列 index 備援）。
  const doc = id ? getComponentById(decodeURIComponent(id)) : undefined;
